...
export default function Navbar({ho,inte,pro}) {
    return (<div className="navbar flex-row">
        ...
        <div className="flex-row navbar-list">
            ...
            <div className="navbar__item laptop" onClick={() => {if (pro.current) {pro.current.scrollIntoView({ behavior: 'smooth' });}}}>Projects</div>
